...
Date: 06/07/2021
Description: Modbus TCP communication test getting key records
https://github.com/AiltonFidelix/TUF-2000M/blob/main/main.py
"""

from time import sleep
from struct import pack, unpack
from minimalmodbus import Instrument, MODE_ASCII
import serial
...
def readLongReg(regOne, regTwo):
    print("foo %s" % (instrument.read_register(regOne)))
    #print("bar %s" % (instrument.read_register(regTwo)))
    sys.exit(0)
